...
import Empire1 from "../../../assets/images/RealestateTT/EmpireCity/Empire1.jpg";
import Empire2 from "../../../assets/images/RealestateTT/EmpireCity/Empire2.jpg";
import Empire3 from "../../../assets/images/RealestateTT/EmpireCity/Empire3.jpg";
import Empire4 from "../../../assets/images/RealestateTT/EmpireCity/Empire4.jpg";
import Empire5 from "../../../assets/images/RealestateTT/EmpireCity/Empire5.jpg";
import Empire6 from "../../../assets/images/RealestateTT/EmpireCity/Empire6.jpg";
import Empire7 from "../../../assets/images/RealestateTT/EmpireCity/Empire7.jpg";
import Empire8 from "../../../assets/images/RealestateTT/EmpireCity/Empire8.jpg";
import Empire9 from "../../../assets/images/RealestateTT/EmpireCity/Empire9.jpg";

import Vitri1 from "../../../assets/images/RealestateTT/EmpireCity/Vitri1.jpg";
import Vitri2 from "../../../assets/images/RealestateTT/EmpireCity/Vitri2.jpg";
      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-[2fr_1fr] lg:grid-cols-[2fr_1fr]">
          <div className="rounded my-4">
            ...
            <p className="text-sm text-gray-600 mb-3">
              Đường Mai Chí Thọ, phường Thủ Thiêm, quận 2, Tp.HCM.
            </p>
            <div
                ...
                >
                  ...
                  <div className="absolute bottom-4 left-4 bg-black bg-opacity-60 text-white p-4 rounded">
                    ...
                    <p className="text-sm font-bold md:text-base">
                      {slide.description || "Diện tích: 14,5 ha"}
                    </p>
                  </div>
                </div>
              ))}
            ...
            <div>
              <p className="text-sm text-gray-600 my-5">
                Khu đô thi Empire City Thủ Thiêm là dự án căn hộ chung cư hạng
                sang tại khu vực trung tâm Thủ Thiêm của thành phố mới Thủ Đức.
                Dự án là tổ hợp gồm khách sạn 5 sao, khu trung tâm thương mại
                cao cấp, văn phòng và tòa tháp đa năng cao 86 tầng. Đặc biệt,
                tòa tháp này là điểm nhấn cao nhất của Khu đô thị mới Thủ Thiêm,
                Sài Gòn cũng là tòa tháp cao nhất Việt Nam.
              </p>
              <p className="text-sm text-gray-600 my-5">
                Cuối tháng 6/2015, UBND Tp.HCM đã chính thức trao Giấy Chứng
                nhận đầu tư cho Công ty TNHH Liên doanh Thành phố Đế Vương triển
                khai Dự án Khu phức hợp Tháp quan sát Empire City Thủ Thiêm
                trong Khu lõi trung tâm của Khu đô thị mới Thủ Thiêm.
              </p>
            </div>
          </div>
              ...
              <table className="table-auto border-collapse border border-gray-300 w-full text-sm text-left">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td className="border border-gray-300 px-4 py-2">
                      14,5 ha với các khu dân cư, khu phức hợp thương mại
                    </td>
                  </tr>
                  <tr>
                    <td className="border border-gray-300 px-4 py-2">
        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-[2fr_1fr] lg:grid-cols-[2fr_1fr]">
          <div className="rounded py-6">
            ...
            <div className="p-2">
              <p className="text-sm text-gray-600 mb-3">
                Dự án Empire City Thủ Thiêm tọa lạc tại trung tâm Khu đô thị Thủ
                Thiêm, nằm dọc trục đường Mai Chí Thọ (Đại lộ Đông Tây) chạy ven
                theo sông Sài Gòn. Dự án kết nối linh hoạt và rất thuận lợi đến
                chợ Bến Thành, khu vực trung tâm quận 1 và những khu chức năng
                quan trọng của TP.HCM.
              </p>
              <p className="text-sm text-gray-600 mb-3">
                Empire City nằm ở phía Nam của khu lõi trung tâm thuộc khu chức
                năng số 2 trong khu đô thị mới Thủ Thiêm là tổ hợp gồm khu trung
                tâm thương mại cao cấp, khách sạn 5 sao, văn phòng…Và đặc biệt
                là tòa tháp đa năng cao 88 tầng, điểm nhấn cao nhất khu đô thị
                mới Thủ Thiêm và cũng là tòa nhà cao nhất Việt Nam trong tương
                lai.
              </p>
