...
import Manor1 from "../../../assets/images/RealestateBT/Manor/Manor1.jpg";
import Manor2 from "../../../assets/images/RealestateBT/Manor/Manor2.jpg";
import Manor3 from "../../../assets/images/RealestateBT/Manor/Manor3.jpg";
import Manor4 from "../../../assets/images/RealestateBT/Manor/Manor4.jpg";
import Manor5 from "../../../assets/images/RealestateBT/Manor/Manor5.jpg";
import Manor6 from "../../../assets/images/RealestateBT/Manor/Manor6.jpg";

import Vitri1 from "../../../assets/images/RealestateBT/Manor/Vitri1.jpg";
import Vitri2 from "../../../assets/images/RealestateBT/Manor/Vitri2.jpg";
import Vitri3 from "../../../assets/images/RealestateBT/Manor/Vitri3.jpg";
...
const areas2 = [
  ...
  {
    id: 2,
    content: "Mặt bằng tầng điển hình block C, D, E, F ",
    image: Vitri3,
  },
];
      ...
      <div className="max-w-7xl mx-auto">
          ...
          <div className="rounded my-4">
                ...
                >
                  ...
                  <div className="absolute bottom-4 left-4 bg-black bg-opacity-60 text-white p-4 rounded">
                    ...
                    <p className="text-sm font-bold md:text-base">
                      {slide.description || "Diện tích: 1,36 ha"}
                    </p>
                  </div>
                </div>
              ))}
            ...
            <div className="flex justify-between items-center my-3">
              <h2 className="text-xl font-bold text-blue-900">
                59,36 - 78,32 triệu/ m2
              </h2>
              <p className="text-sm font-bold text-gray-700">1049 CĂN HỘ</p>
            </div>
            <hr />
            <div>
              <p className="text-sm text-gray-600 my-5">
                Dự án The Manor - TP. Hồ Chí Minh (The Manor Hồ Chí Minh) là khu
                căn hộ chung cư mang phong cách kiến trúc cổ điển Pháp do Tập
                đoàn Bitexco xây dựng tại quận Bình Thạnh, TP.HCM. Ngoài The
                Manor TP.HCM, Bitexco cũng phát triển một dự án The Manor khác ở
                Hà Nội.
              </p>
              <p className="text-sm text-gray-600 mb-5">
                Chung cư The Manor TP.HCM gồm 7 block cao 29 tầng với tổng cộng
                1049 căn hộ và officetel. Ngoài các căn hộ cao cấp phía trên,
                khối đế thương mại của dự án có đầy đủ các tiện ích, dịch vụ,
                hình thành một cộng đồng hoàn chỉnh, tiện nghi.
              </p>
            </div>
          </div>
              ...
              <table className="table-auto border-collapse border border-gray-300 w-full text-sm text-left">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td className="border border-gray-300 px-4 py-2">7 toà</td>
                  </tr>
                  <tr>
                    <td className="border border-gray-300 px-4 py-2">
                      Đơn vị thi công
        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-[2fr_1fr] lg:grid-cols-[2fr_1fr]">
          <div className="rounded py-6">
            ...
            <div className="p-2">
              <p className="text-sm text-gray-600 mb-3">
                Dự án chung cư The Manor TP.HCM nằm trên mặt đường Nguyễn Hữu
                Cảnh, quận Bình Thạnh. Sở hữu tầm nhìn ra sông Sài Gòn và khu đô
                thị mới Thủ Thiêm, chung cư The Manor TP.HCM nằm trong “tọa độ
                vàng” quy tụ những dự án bất động sản cao cấp, một trong những
                nơi “đáng sống” nhất TP.HCM.
              </p>
              <p className="text-sm text-gray-600 mb-3">
                1km đến cầu Thủ Thiêm 1,5km KĐT Vinhomes Central Park 4km đến
                khu Thảo Điền, Quận 2 5km đến chợ Bến Thành, trung tâm Quận 1.
              </p>
