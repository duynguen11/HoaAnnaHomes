...
import Q21 from "../../../assets/images/RealestateQ2/Q2TĐ/Q2TĐ1.jpg";
import Q22 from "../../../assets/images/RealestateQ2/Q2TĐ/Q2TĐ2.jpg";
import Q23 from "../../../assets/images/RealestateQ2/Q2TĐ/Q2TĐ3.jpg";
import Q24 from "../../../assets/images/RealestateQ2/Q2TĐ/Q2TĐ4.jpg";
import Q25 from "../../../assets/images/RealestateQ2/Q2TĐ/Q2TĐ5.jpg";
import Q26 from "../../../assets/images/RealestateQ2/Q2TĐ/Q2TĐ6.jpg";

import Vitri1 from "../../../assets/images/RealestateQ2/Q2TĐ/Vitri1.jpg";
      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-[2fr_1fr] lg:grid-cols-[2fr_1fr]">
          <div className="rounded my-4">
            ...
            <p className="text-sm text-gray-600 mb-3">
              Đường Võ Trường Toản, Phường Thảo Điền, Quận 2, Hồ Chí Minh.
            </p>
            <div
                ...
                >
                  ...
                  <div className="absolute bottom-4 left-4 bg-black bg-opacity-60 text-white p-4 rounded">
                    ...
                    <p className="text-sm font-bold md:text-base">
                      {slide.description || "Diện tích: 7,957 ha"}
                    </p>
                  </div>
                </div>
              ))}
            ...
            <div>
              <p className="text-sm text-gray-600 my-5">
                Q2 Thảo Điền là dự án căn hộ đẳng cấp, mang đến diện mạo mới
                hiện đại cho khu Thảo Điền nói riêng và trung tâm quận 2 nói
                chung. Đây là dự án căn hộ cuối cùng thuộc phân khúc hạng sang
                của Phường Thảo Điền với vị trí đắc địa, thiết kế tinh tế với
                nội thất sang trọng và các tiện ích tiêu chuẩn 5 sao…
              </p>
              <p className="text-sm text-gray-600 my-5">
                Dự án Q2 Thảo Điền nằm ngay cạnh dự án Gateway Thảo Điền,
                Masteri An Phú, The Nassim, Masteri Thảo Điền. <br />- Chủ đầu
                tư: Frasers Centrepoint (Singapore) <br />- Diện tích khu đất:
                7.956m2 <br />- Quy mô: 1 tòa nhà cao 32 tầng và khối đế 5 tầng{" "}
                <br />- Số căn hộ: 300 căn hộ cao cấp gồm hơn 100 căn hộ dịch vụ
                cho thuê và hơn 30 căn nhà phố <br />- biệt thự thấp tầng khác
              </p>
            </div>
          </div>
              ...
              <table className="table-auto border-collapse border border-gray-300 w-full text-sm text-left">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td className="border border-gray-300 px-4 py-2">
                      1 tòa nhà cao 32 tầng và khối đế 5 tầng
                    </td>
                  </tr>
                  <tr>
                    <td className="border border-gray-300 px-4 py-2">
        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-[2fr_1fr] lg:grid-cols-[2fr_1fr]">
          <div className="rounded py-6">
            ...
            <div className="p-2">
              <p className="text-sm text-gray-600 mb-3">
                Khu dự án căn hộ Q2 Thảo Điền nằm ngay tại trung tâm Thảo Điền,
                quận 2, Tp.HCM. Có thể nói, dự án sở hữu một vị trí đẳng cấp
                ngay trong quy hoạch trung tâm thành phố mới với view siêu đẹp
                ra toàn cảnh thành phố.
              </p>
