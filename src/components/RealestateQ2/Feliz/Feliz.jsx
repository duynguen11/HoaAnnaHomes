...
import Feliz1 from "../../../assets/images/RealestateQ2/Feliz/Feliz1.jpg";
import Feliz2 from "../../../assets/images/RealestateQ2/Feliz/Feliz2.jpg";
import Feliz3 from "../../../assets/images/RealestateQ2/Feliz/Feliz3.jpg";
import Feliz4 from "../../../assets/images/RealestateQ2/Feliz/Feliz4.jpg";
import Feliz5 from "../../../assets/images/RealestateQ2/Feliz/Feliz5.jpg";
import Feliz6 from "../../../assets/images/RealestateQ2/Feliz/Feliz6.jpg";

import Vitri1 from "../../../assets/images/RealestateQ2/Feliz/Vitri1.jpg";
import Vitri2 from "../../../assets/images/RealestateQ2/Feliz/Vitri2.jpg";
      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-[2fr_1fr] lg:grid-cols-[2fr_1fr]">
          <div className="rounded my-4">
            ...
            <p className="text-sm text-gray-600 mb-3">
              02 Phan Văn Đáng, Phường Thạnh Mỹ Lợi, Quận 2, Hồ Chí Minh.
            </p>
            <div
                ...
                >
                  ...
                  <div className="absolute bottom-4 left-4 bg-black bg-opacity-60 text-white p-4 rounded">
                    ...
                    <p className="text-sm font-bold md:text-base">
                      {slide.description || "Diện tích: 2,6 ha"}
                    </p>
                  </div>
                </div>
              ))}
            ...
            <div className="flex justify-between items-center my-3">
              <h2 className="text-xl font-bold text-blue-900">
                79,42 - 146,58 triệu/m²
              </h2>
              <p className="text-sm font-bold text-gray-700">1,127 CĂN HỘ</p>
            </div>
            <hr />
            <div>
              <p className="text-sm text-gray-600 my-5">
                Feliz En Vista là dự án căn hộ cao cấp tại Thạnh Mỹ Lợi Quận 2
                của CapitaLand Development. Dự án có diện tích hơn 2 ha, gồm 4
                tòa chung cư cao 34 tầng. Dự án cung ứng cho thị trường 960 căn
                hộ cao cấp sở hữu View sông Sài Gòn thoàng đãng. Các căn hộ
                Feliz En Vista nằm gần với các tiện ích như kho bạc, UBND TP.Thủ
                Đức, bệnh viện, điện lực, các trường học quốc tế và nhất là công
                viên ven sông có diện tích hơn 10 ha.
              </p>
            </div>
          </div>
              ...
              <table className="table-auto border-collapse border border-gray-300 w-full text-sm text-left">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td className="border border-gray-300 px-4 py-2">2,6ha</td>
                  </tr>
                  <tr>
                    <td className="border border-gray-300 px-4 py-2">
                      Pháp lý
        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-[2fr_1fr] lg:grid-cols-[2fr_1fr]">
          <div className="rounded py-6">
            ...
            <div className="p-2">
              <p className="text-sm text-gray-600 mb-3">
                Dự án Feliz En Vista toạ lạc tại đường Phan Văn Đáng, Thạnh Mỹ
                Lợi, Quận 2, nay là TP.Thủ Đức, đối diện với chung cư Vista
                Verde cũng do CapitaLand đầu tư và phát triển. Dự án khu căn hộ
                Feliz En Vista nằm liền kề với đường Mai Chí Thọ và tiếp giáp
                với nhiều các tuyến đường lớn nhỏ khác nhau như: Phan Văn Đáng,
                Trương Văn Bang, Lê Hiền Mai …Từ dự án, cư dân dễ dàng tiếp cận
                với những tiện ích ngoại khu như:
              </p>
              <p className="text-sm text-gray-600 mb-3">
                3,4 km đến Mega Market 1,5 km đến bệnh viện Phúc An Khang 1,9 km
                đến trường quốc tế Úc AIS 6 km đến hầm Thủ Thiêm kết nối trực
                tiếp với quận 1 6,8 km đến cầu Phú Mỹ kết nối trực tiếp với quận
                7
              </p>
